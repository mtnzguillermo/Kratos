...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THETA_1 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THETA_2 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THETA_3 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, XI_DAMPING)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, NODAL_DIAGONAL_STIFFNESS)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, NODAL_DIAGONAL_DAMPING)
