...
KRATOS_CREATE_VARIABLE(double, XI_DAMPING)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(NODAL_DIAGONAL_STIFFNESS)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(NODAL_DIAGONAL_DAMPING)
